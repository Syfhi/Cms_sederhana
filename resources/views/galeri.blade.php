          ...
          <div class="row gy-4 portfolio-container">
            <div class="col-xl-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-wrap">
                <a href="gambar\{{$galeri->pict}}" data-gallery="portfolio-gallery-app" class="glightbox"><img src="gambar\{{$galeri->pict}}" class="img-fluid" alt=""></a>
                <div class="portfolio-info">
                  <h4><a href="portfolio-details.html" title="More Details">{{$galeri->nama_galeri}}</a></h4>
                  <p>{{$galeri->deskripsi_galeri}}</p>
                </div>
              </div>
