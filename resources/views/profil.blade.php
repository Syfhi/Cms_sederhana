...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark py-3">
        ...
        <h1 class='display-5 fw-bolder mb-0'><span class='text-gradient d-inline'>Profil Sekolah</span></h1>
        <table border="1">
          @foreach($tampilprofil as $profil)
        <tr>
            <th>Nama Sekolah</th>
            <td style='background-color:silver;'>{{$profil->nama}}</td>
        </tr>
        <tr>
            <th>Alamat</th>
            <td style='background-color:silver;'>{{$profil->alamat}}</td>
        </tr>
        <tr>
            <th>Kota</th>
            <td style='background-color:silver;'>{{$profil->kota}}</td>
        </tr>
        <tr>
            <th>Provinsi</th>
